          ...
          <div className="flex flex-col flex-1 overflow-hidden bg-slate-50">
            ...
            {activeTab === 'passwords' && (
              <div className="p-4 sm:p-6 overflow-y-auto space-y-6">
                {/* Individual Student Credentials Banner */}
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 text-xs text-blue-900 flex items-start gap-3 shadow-2xs">
                  ...
                  <div className="space-y-1">
                    <p className="font-bold text-blue-950">
                      Individual Student Account Authentication Active
                    </p>
                    <p className="text-blue-800 leading-relaxed">
                      Shared/global entrance passwords have been removed. Every engineering student registers and signs in securely with their own individual email and personal password. You can manage or reset any student's password in the Student Management tab of the Admin Panel.
                    </p>
                  </div>
                </div>
